...
<section class="content-section no-spacing">
  <div class="container">
    <div class="row align-items-center no-gutters">
		...
		<div class="col-lg-7">
			<div class="tab-right">
			 <div id="tab01" class="tab-item active-item"><img src="<?php bloginfo('template_url');?>/images/tab01.jpg" alt="Image"></div>
        <!-- end tab01 -->
        <div id="tab02" class="tab-item"><img src="<?php bloginfo('template_url');?>/images/tab02.jpg" alt="Image"> </div>
        <!-- end tab02 -->
        <div id="tab03" class="tab-item"><img src="<?php bloginfo('template_url');?>/images/tab03.jpg" alt="Image"> </div>
        <!-- end tab03 -->
        <div id="tab04" class="tab-item"><img src="<?php bloginfo('template_url');?>/images/tab04.jpg" alt="Image"> </div>
        <!-- end tab04 -->
        <div id="tab05" class="tab-item"><img src="<?php bloginfo('template_url');?>/images/tab05.jpg" alt="Image"> </div>
        <!-- end tab05 --> 
			</div>
			<!-- end tab-right -->
		</div>
