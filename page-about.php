  ...
  <div class="container">
    <div class="row">
		<div class="col-12">
          ...
          <h2>Fortezza<br> Grupo Constructor</h2>
        </div>
        <!-- end section-title --> 
		</div>
		<!-- end col-12 -->
	  	<div class="col-md-7">
		<figure><img src="<?php bloginfo('template_url');?>/images/slide01.jpg" alt="Image"></figure>
		...
		<!-- end col-7 -->
	  	<div class="col-md-5">
		<figure><img src="<?php bloginfo('template_url');?>/images/side-image02.png" alt="Image"></figure>
  ...
  <div class="container">
    <div class="row">
      ...
      <!-- end col-5 --> 
	  	<div class="col-lg-4">
		<div class="step-box">
			<figure class="image"><img src="<?php bloginfo('template_url');?>/images/step01.jpg" alt="Image"></figure>
			<div class="content">
				<span>01.</span>
			<figure class="icon"><img src="<?php bloginfo('template_url');?>/images/icon01.png" alt="Image"></figure>
				<h6>OUR PEOPLE</h6>
    ...
    <div class="row">
      <div class="col-12">
        <div class="section-title text-left">
          ...
          <h2>Ofrecemos compromiso en todos <br>los proyectos de construcci&oacute;n</h2>
        </div>
        <!-- end section-title --> 
      </div>
      <!-- end col-12 -->
		<div class="col-lg-8">
            ...
            <div class="card">
              <div class="card-header" role="tab" id="headingOne"> <a data-toggle="collapse" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Dedicación a la satisfacción del cliente <i class="lni lni-arrow-right"></i></a> </div>
            ...
            <!-- end card -->
            <div class="card">
              <div class="card-header" role="tab" id="headingTwo"> <a class="collapsed" data-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">¿Dónde puedo encontrar calificaciones crediticias y de bonos de una empresa concreta? <i class="lni lni-arrow-right"></i></a> </div>
            ...
            <!-- end card -->
            <div class="card">
              <div class="card-header" role="tab" id="headingThree"> <a class="collapsed" data-toggle="collapse" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">¿Dónde puedo acceder a las propiedades personalizadas? <i class="lni lni-arrow-right"></i></a> </div>
            ...
            <!-- end card --> 
            <div class="card">
              <div class="card-header" role="tab" id="headingFour"> <a class="collapsed" data-toggle="collapse" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">¿Dónde puedo encontrar el Wall Street Journal de hoy y el histórico? <i class="lni lni-arrow-right"></i></a> </div>
